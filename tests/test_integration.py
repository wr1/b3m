...
def test_full_pipeline(sample_config):
    ...
    with tempfile.TemporaryDirectory() as tmpdir:
        ...
        with (
            ...
            patch("b3_msh.step.blade_mesh_step.B3MshStep") as mock_mesh,
            ...
            mock_anba.assert_called_once_with(str(config_path))
            mock_anba.return_value.run.assert_called_once()
